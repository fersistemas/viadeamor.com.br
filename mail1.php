...
$Mailer->IsSMTP(); 
$Mailer->Host ="mail.viadeamor.com.br"; 
$Mailer->SMTPAuth = true; 
$Mailer->Username = "contato@viadeamor.com.br"; 
$Mailer->Password = "vfpvfpvfp1"; 
$Mailer->SMTPSecure = "tls"; 
$Mailer->Port = 587; 
$Mailer->From = "contato@viadeamor.com.br"; 
$Mailer->FromName = "FerSistemas1@gmail.com"; 
$Mailer->AddAddress("$Email"); 
$Mailer->AddAddress("fersistemas1@gmail.com"); 
$Mailer->IsHTML(true); 
$Mailer->Subject = "Obrigado->Registro: $Nome($Email)".date("d/m/Y"); 
$Mailer->Body = "Obrigado pelo seu registro - <br /> E-mail: {$Email}<br />
Caso nao tenha registrado seu <br />
email para este recebimento<br />
Basta apenas desconsiderar esta mensagem<br />
<br />
Dados Inseridos no Formulario:<br /><br />
Nome: {$Nome} <br />
Cep: {$Cep} <br />
Rua: {$Rua} <br />
Bairro: {$Bairro} <br />
...
<head>
<meta charset="utf-8">
<title>E-mail encaminhado</title>
</head>

<body>
Obrigado pelo seu registro - > <br />
Este Formulario foi enviado também para o seu email:<br /> 
<?php echo $Email; ?> <br /><br />
Se não encontrar na Caixa de Entrada, <br />
Verifique sua Caixa de Spam, <br />
ou tente enviar o formulario novamente<br />
<br />
Caso nao tenha se registrado recentemente<br />
em formulario para o recebimento desta mensagem <br />
Basta apenas desconsiderar este e-mail<br />
<br />
Dados Inseridos no Formulario:<br /><br />

<br /><br />
Seus dados enviados: <br /><br />
...
Estado: <?php echo $Uf; ?> <br />
Numero: <?php echo $Numeral; ?> <br />
